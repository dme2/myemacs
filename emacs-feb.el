...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (hasklig-mode rust-mode evil-visual-mark-mode flycheck-irony company-irony-c-headers company-irony irony rtags scala-mode intero solarized-theme typescript-mode pdf-tools markdown-mode ox-gfm clojure-mode exec-path-from-shell treemacs doom-themes ## dracula-theme geiser slime erlang go-mode haskell-mode latex-preview-pane auctex auto-complete-clang auto-complete)))
